...
/** A numbered panel of tiles, with its own rule. */
function Board({
  n,
  grid,
  children,
  ...
  return (
    <div className="mt-16 first:mt-0 md:mt-20">
      <div className="border-b border-rule pb-4">
        <p className="font-mono text-[0.7rem] tracking-[0.24em] text-brand uppercase">{n}</p>
      </div>
      <div
  ...
  return (
    <Section id="about" labelledBy="about-heading">
      ...
      <div className="mt-12 md:mt-16">
        ...
        <Board n="02" grid="auto-rows-[minmax(12rem,auto)] lg:grid-cols-3">
          {phases.map((phase, i) => (
            <Tile
              key={phase.n}
